        ...
        synchronized (mBgDataModel) {
            ...
            try {
                ...
                while (!mStopped && c.moveToNext()) {
                    try {
                        ...
                        case LauncherSettings.Favorites.ITEM_TYPE_FOLDER:
                            ...
                            c.checkAndAddItem(folderInfo, mBgDataModel);*/ // oem.c
                            break;
                ...
                for (int i = 0; i < mBgAllAppsList.size(); i++) {
                    ...
                    // Do not trim the folder label, as is was set by the user.
                    folderInfo.title = mBgAllAppsList.get(i).title;
                    folderInfo.spanX = mBgAllAppsList.get(i).spanX;
                    folderInfo.spanY = mBgAllAppsList.get(i).spanY;
                    //folderInfo.options = c.getInt(optionsIndex);
